...
welcome.default <- function(e, ...){
  swirl_out(s()%N%"Welcome to swirl!")
  swirl_out(s()%N%"Please sign in. If you've been here before, use the same name as you did then. If you are new, call yourself something unique.", skip_after=TRUE)
