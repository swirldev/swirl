...
If you want to use integers in R, you must specify the `L` suffix. Otherwise, R will treat numeric values as real (decimal) numbers. (Ex: `3L` is an integer; `3` is a real number). Let's explore this theme some more by looking the most fundamental data types in R.
