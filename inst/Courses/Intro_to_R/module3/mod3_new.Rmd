...
*** .hint
Don't create a new variable on this one. We just want to see the result of `num_vect >= 10`. Make sure there is no space between the `>` and `=` symbols. Think of them as one symbol representing "greater than or equal to".
...
*** .ans_tests
is_a=character, my_name; uses_func=c; creates_var=my_name
