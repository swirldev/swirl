...
*** .hint
Try `rep(c(0, 1, 2), times = 20)` for a different variation on the same theme. Be sure to use the `c()` function to tell R that the numbers 0, 1, and 2 make up a vector.
