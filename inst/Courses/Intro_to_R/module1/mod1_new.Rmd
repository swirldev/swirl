...
*** .hint
Just type `5 + 7` and press Enter. Don't include the backticks (``) in your input. They are only there to denote an R command.
...
*** .hint
Inputing `z <- c(1.1, 9, 3.14)` will assign the vector (1.1, 9, 3.14) to a new variable called `z`. Including single spaces after the commas in the vector is not required, but helps make your code less cluttered and more readable.
